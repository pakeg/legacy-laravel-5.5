...
class GalleryPageController extends Controller
{
    ...
    {
    	$photo_arch = Post::where('type', '4')->orderBy('created_at', 'desc')->take(20)->get();

    	$photos = Post::where('type', '4')->orderBy('created_at', 'desc')->paginate(6);

        $thumb = UploadImage::load('post', '250');

        return view('layouts.common.gallery', compact('photos', 'photo_arch', 'thumb'));
    }
    ...
    public function gallery($id)
    {
        ...
        return view('layouts.common.gallerypage._gallery')->with(['post'=>$post, 'thumb'=>$thumb, 'image_user'=>$image_user, 'posts_arch'=>$posts, 'com'=>$com]);
    }
