    ...
    <div class="row">
      <div class="col-md-8 col-8">
      	<div class="right-col" id="news-main">
      		<div class="news-img"><img src="{{$thumb}}{{!empty($post->image) ? $post->image : 'no_image.jpg'}}" alt="{{$post->name}}"></div>
      		...
      		<div class="news-tags">
      			...
      			@foreach ($post->tags as $tag)
      						<a href="{{route('tags', $tag->name)}}"><span class="news-tag">{{$tag->name}}</span></a>
      			@endforeach
      		</div>
      		<div class="news-soc">
