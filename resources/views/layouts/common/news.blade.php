    ...
    <div class="row">
      <div class="col-md-8 col-8">
      	<div class="right-col" id="news-main">
      		<div class="news-title"><span>АРХИВ НОВОСТЕЙ</span></div>
	      	...
	      	<div class="news-pag">
		    		...
		    		@if ($post_list->currentPage() > 1)
							<a href="{{$post_list->previousPageUrl()}}"> <i class="fas fa-chevron-left"></i> </a>
						@else
							<a> <i class="fas fa-chevron-left"></i> </a>
						@endif
						@if ($post_list->lastPage() != $post_list->currentPage())
							<a href="{{$post_list->nextPageUrl()}}"> <i class="fas fa-chevron-right"></i> </a>
						@else
